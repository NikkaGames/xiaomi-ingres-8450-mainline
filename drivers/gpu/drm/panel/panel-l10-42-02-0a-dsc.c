...
static inline
struct l10_42_02_0a_dsc *to_l10_42_02_0a_dsc(struct drm_panel *panel)
{
	return container_of(panel, struct l10_42_02_0a_dsc, panel);
}

static void l10_42_02_0a_dsc_reset(struct l10_42_02_0a_dsc *ctx)
{
...
static int l10_42_02_0a_dsc_on(struct l10_42_02_0a_dsc *ctx)
{
...
static int l10_42_02_0a_dsc_off(struct l10_42_02_0a_dsc *ctx)
{
	struct mipi_dsi_device *dsi = ctx->dsi;
	struct device *dev = &dsi->dev;
	int ret;
...
static int l10_42_02_0a_dsc_prepare(struct drm_panel *panel)
{
	struct l10_42_02_0a_dsc *ctx = to_l10_42_02_0a_dsc(panel);
	...
	l10_42_02_0a_dsc_reset(ctx);

	ret = l10_42_02_0a_dsc_on(ctx);
	if (ret < 0) {
...
static int l10_42_02_0a_dsc_unprepare(struct drm_panel *panel)
{
	struct l10_42_02_0a_dsc *ctx = to_l10_42_02_0a_dsc(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;

	ret = l10_42_02_0a_dsc_off(ctx);
	if (ret < 0)
...
static const struct drm_display_mode l10_42_02_0a_dsc_mode = {
...
static int l10_42_02_0a_dsc_get_modes(struct drm_panel *panel,
				     struct drm_connector *connector)
{
	return drm_connector_helper_get_modes_fixed(connector, &l10_42_02_0a_dsc_mode);
}

static const struct drm_panel_funcs l10_42_02_0a_dsc_panel_funcs = {
	.prepare = l10_42_02_0a_dsc_prepare,
	.unprepare = l10_42_02_0a_dsc_unprepare,
	.get_modes = l10_42_02_0a_dsc_get_modes,
};

static int l10_42_02_0a_dsc_bl_update_status(struct backlight_device *bl)
{
...
static int l10_42_02_0a_dsc_bl_get_brightness(struct backlight_device *bl)
{
	struct mipi_dsi_device *dsi = bl_get_data(bl);
	u16 brightness;
	int ret;
...
static const struct backlight_ops l10_42_02_0a_dsc_bl_ops = {
	.update_status = l10_42_02_0a_dsc_bl_update_status,
	.get_brightness = l10_42_02_0a_dsc_bl_get_brightness,
};

static struct backlight_device *
l10_42_02_0a_dsc_create_backlight(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
	...
	return devm_backlight_device_register(dev, dev_name(dev), dev, dsi,
					      &l10_42_02_0a_dsc_bl_ops, &props);
}

static int l10_42_02_0a_dsc_probe(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
	struct l10_42_02_0a_dsc *ctx;
	int ret;
	...
	drm_panel_init(&ctx->panel, dev, &l10_42_02_0a_dsc_panel_funcs,
		       DRM_MODE_CONNECTOR_DSI);
	ctx->panel.prepare_prev_first = true;

	ctx->panel.backlight = l10_42_02_0a_dsc_create_backlight(dsi);
...
static void l10_42_02_0a_dsc_remove(struct mipi_dsi_device *dsi)
{
	struct l10_42_02_0a_dsc *ctx = mipi_dsi_get_drvdata(dsi);
	int ret;
...
static struct mipi_dsi_driver l10_42_02_0a_dsc_driver = {
...
module_mipi_dsi_driver(l10_42_02_0a_dsc_driver);

MODULE_AUTHOR("Nika Okromtchedlishvili <okromtchedlishvilinika@gmail.com>");
